...
namespace MIConvexHull.ConvexHull
{
    ...
    class MathHelper
    {
		...
		readonly double[] _positionData;

		readonly double[] _ntX;
		readonly double[] _ntY;
		readonly double[] _ntZ;
		readonly double[] _nDNormalHelperVector;
		readonly double[] _nDMatrix;
		readonly int[] _matrixPivots;

        #region Normals
        // Modified from Math.NET
        // Copyright (c) 2009-2013 Math.NET
        static void LuFactor(IList<double> data, int order, IList<int> ipiv, IList<double> vecLUcolj)
        {
...
*/
        ...
        void FindNormalVector4D(IList<int> vertices, IList<double> normal)
        {
        ...
        /// <param name="vertices"></param>
        /// <param name="normal"></param>
        void FindNormalVector3D(IList<int> vertices, IList<double> normal)
        {
            SubtractFast(vertices[1], vertices[0], _ntX);
            SubtractFast(vertices[2], vertices[1], _ntY);
        ...
        /// <param name="vertices"></param>
        /// <param name="normal"></param>
        void FindNormalVector2D(IList<int> vertices, IList<double> normal)
        {
            SubtractFast(vertices[1], vertices[0], _ntX);
        ...
        void FindNormalVectorNd(IList<int> vertices, IList<double> normal)
        {
            /*
