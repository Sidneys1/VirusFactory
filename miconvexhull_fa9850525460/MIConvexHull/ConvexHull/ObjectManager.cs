...
namespace MIConvexHull.ConvexHull
{
    ...
    class ObjectManager
    {
		...
		readonly ConvexHullInternal _hull;
        int _facePoolSize, _facePoolCapacity;
        ConvexFaceInternal[] _facePool;
		readonly IndexBuffer _freeFaceIndices;
        FaceConnector _connectorStack;
		readonly SimpleList<IndexBuffer> _emptyBufferStack;
		readonly SimpleList<DeferredFace> _deferredFaceStack;
