...
namespace VirusFactory.Model.Geography {
    ...
    public struct Connection<T> where T : ICoordinate {
        ...
        public static double Distance(double lat1, double lon1, double lat2, double lon2, bool exact = false) {
            var theta = lon1 - lon2;
        ...
        public static double Distance(T p1, T p2, bool exact = false) {
            return Distance(p1.Latitude, p1.Longitude, p2.Latitude, p2.Longitude, exact);
        }
