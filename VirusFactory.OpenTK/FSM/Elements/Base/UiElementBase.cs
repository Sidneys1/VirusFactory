...
namespace VirusFactory.OpenTK.FSM.Elements.Base {
	public abstract class UiElementBase : GameElementBase, IBehavioral<UiElementBase>, IRenderable, IKeyboardInput, IMouseInput, IResizable {
		#region Properties
		...
		public MultiMap<int, Behaviour<UiElementBase>> Behaviours { get; } = new MultiMap<int, Behaviour<UiElementBase>>();
		...
		protected UiElementBase(GameWindow owner) : base(owner) {
		}
